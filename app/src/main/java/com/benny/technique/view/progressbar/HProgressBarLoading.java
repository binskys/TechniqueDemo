package com.benny.technique.view.progressbar;
...
import com.benny.technique.utils.DimenUtils;
...
public class HProgressBarLoading extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            mWidth = DimenUtils.dp2px(mContext, 300);
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            mHeight = DimenUtils.dp2px(mContext, mDefaultHeight);
        }
